                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="color: brown; font-size:bold;">
                            <li><a class="dropdown-item " href="search.php?cat=medicine">CCTV camera</a></li>
                            <li><a class="dropdown-item" href="search.php?cat=self-care">Digital locker and vault</a></li>
                            <li><a class="dropdown-item" href="search.php?cat=machine"> Packages</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
